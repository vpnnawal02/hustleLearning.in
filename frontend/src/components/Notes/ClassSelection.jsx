            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {classes.map((cls) => (
                    <button
                        ...
                        className={`bg-gradient-to-br ${cls.color} bg-[#1E1E1E] border-2 border-gray-800 rounded-2xl p-8 hover:border-[#FFC107] hover:scale-105 transition-all duration-300 group`}
                    >
